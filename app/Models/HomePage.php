...
class HomePage extends Model
{
    ...
    protected $fillable = [
        ...
        'link13', 'link14', 'link15','list_top','list_middle','list_footer'
    ];
    ...
    public static function editHomePage($data){
        ...
        if(isset($data)){
            $arr_update  = array(
                ...
                "link14"      => $data['link14'],
                "link15"      => $data['link15'],
                "list_top"    => !empty($data['list_top']) ? implode("|", $data['list_top']) : "",
                "list_middle" => !empty($data['list_middle']) ? implode("|", $data['list_middle']) : "",
                "list_footer" => !empty($data['list_footer']) ? implode("|", $data['list_footer']) : "",
            );
