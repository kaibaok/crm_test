        ...
        <div class="title_right">
            <div class=" pull-right">
              <div class="input-group">
                ...
                <a class="btn btn-info" href="/admin/slider">Trở về</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="x_content">
                {{ csrf_field() }}
                    ...
                    <div class="item form-group image_upload">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Hình ảnh <span class="required">* 1920x320</span></label>
                         <div class="col-md-4 col-sm-4 col-xs-12 ">
