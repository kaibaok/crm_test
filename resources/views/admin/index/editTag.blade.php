              ...
              <div class="x_content">
                {{ csrf_field() }}
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <div id="status" class="btn-group" data-toggle="buttons">
                              <label><input type="radio" class="flat" name="status" value="0" @if(isset($tag['status']) && $tag['status'] == 0) checked @endif /> Ẩn </label>&nbsp;
                              <label><input type="radio" class="flat" name="status"  value="1" @if(isset($tag['status']) && $tag['status'] == 1) checked @endif /> Hiện</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item form-group @if(isset($errors['title'])) bad @endif">
                       ...
                       <input type="text" id="title" class="form-control col-md-7 col-xs-12" name="title" value="{{isset($tag['title']) ?  $tag['title'] : '' }}" >
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" id="link" class="form-control col-md-7 col-xs-12" name="link" value="{{isset($tag['link']) ?  $tag['link'] : '' }}" >
                        </div>
                    </div>
                </div>
            </div>
