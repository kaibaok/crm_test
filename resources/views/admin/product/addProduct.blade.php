					...
					<div class="item form-group">
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="btn-group" data-toggle="buttons">
								...
								@if (isset($params['size_xs']) && $params['size_xs'] == 1) checked @endif /> XS
								</label> <br>
								<label><input type="checkbox" name="size_s" value="1" class="flat"
								@if (isset($params['size_s']) && $params['size_s'] == 1) checked @endif /> S
								</label><br>
								<label><input type="checkbox" name="size_m" value="1" class="flat"
								@if (isset($params['size_m']) && $params['size_m'] == 1) checked @endif /> M
								</label><br>
								<label><input type="checkbox" name="size_l" value="1" class="flat"
								@if (isset($params['size_l']) && $params['size_l'] == 1) checked @endif /> L
								</label><br>
								<label><input type="checkbox" name="size_xl" value="1" class="flat"
								@if (isset($params['size_xl']) && $params['size_xl'] == 1) checked @endif /> XL
								</label>
							</div>
						</div>
					</div>
