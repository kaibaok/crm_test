			...
			<div class="x_panel">
	          <div class="x_content">
					...
					<div class="item form-group @if(isset($errors['title'])) bad @endif">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
						<input type="text" id="title" class="form-control col-md-7 col-xs-12" name="title" value="{{isset($item['title']) ? $item['title'] : '' }}">
						</div>
					...
					<div class="item form-group @if(isset($errors['seo_link'])) bad @endif">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
						<input type="text" id="seo_link" class="form-control col-md-7 col-xs-12" name="seo_link" value="{{isset($item['seo_link']) ? $item['seo_link'] : '' }}">
						</div>
