                ...
                {{ csrf_field() }}
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <textarea  name="short_desc" id="short_desc" class="form-control" rows="5">@if(isset($product['short_desc'])){{$product['short_desc']}}@endif</textarea>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <textarea  name="desc" id="desc" class="ckedit">@if(isset($product['desc'])){{$product['desc']}}@endif</textarea>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="number" id="discount" class="form-control col-md-7 col-xs-12" name="discount" value="{{isset($product['discount']) ?  $product['discount'] : '' }}" >
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="number" id="percent" class="form-control col-md-7 col-xs-12" name="percent" value="{{isset($product['percent']) ?  $product['percent'] : '' }}" >
                        </div>
                    </div>
