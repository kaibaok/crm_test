            ...
            <div class="table-responsive" id="">
              <table class="table table-striped jambo_table bulk_action" >
                ...
                <tbody id="tbl_alproduct">
                  <?php  $no = 1;  ?>
                  <?php foreach($listTag as $value): ?>
                  <tr class="even pointer">
                    <td><?php echo e($no++); ?></td>
                    <td>
                      <?php if($value->status): ?>
                        <a class="btn_status_product" href="/admin/tag/status/<?php echo e($value->id); ?>" rel="<?php echo e($value->id); ?>"><i class="success fa fa-eye" title="Hiển thị"></i></a>
                      <?php else: ?>
                        <a class="btn_status_product" href="/admin/tag/status/<?php echo e($value->id); ?>" rel="<?php echo e($value->id); ?>"><i class="success fa fa-eye-slash" title="Ẩn"></i></a>
                      <?php endif; ?>
                    </td>
                    ...
                    <td class="last"> <a href="/admin/tag/edit/<?php echo e($value->id); ?>"><i class="success fa fa-edit"></i> Sửa</a> | <a href="/admin/tag/del/<?php echo e($value->id); ?>"><i class="success fa fa-remove"></i> Xóa</a> </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
              <div class="btn-toolbar pull-right">
                  <?php echo e($listTag->appends($conditionPage)->links()); ?>
