...
<form id="demo-form" class="form-horizontal" enctype="multipart/form-data" method="post" action="">
    ...
    <input type="hidden" id="out" name="list" value="<?php echo $menu['list']; ?>">
    <input type="hidden" id="outSP" name="list_sp" value="<?php echo $menu['list_sp']; ?>">
...
<?php $__env->startSection('js'); ?>
    ...
    <script> var strjson = '<?php echo $menu['list']; ?>';
    var strjsonSP = '<?php echo $menu['list_sp']; ?>'; </script>
<?php $__env->stopSection(); ?>
