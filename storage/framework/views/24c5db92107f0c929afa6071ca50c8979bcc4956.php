		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
	          <div class="x_content">
					...
					<input type="hidden" name="id" value="<?php echo e($detail_user['id']); ?>"/>
					<div class="item form-group <?php if(isset($errors['name'])): ?> bad <?php endif; ?>">
						...
						<input type="text" id="name" class="form-control col-md-7 col-xs-12" name="name" required="required" value="<?php echo e($detail_user['name']); ?>">
						</div>
					...
					<div class="item form-group <?php if(isset($errors['gender'])): ?> bad <?php endif; ?>">
						...
						<div id="gender" class="btn-group" data-toggle="buttons">
							...
							<label class="btn btn-default <?php echo e(($detail_user['gender'] == 0) ? 'active' : ''); ?>" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
							<input type="radio" name="gender" value="0" <?php echo e(($detail_user['gender'] == 0) ? 'checked' : ''); ?>> &nbsp; Nam &nbsp;
							</label>
							<label class="btn btn-primary <?php echo e(($detail_user['gender'] == 1) ? 'active' : ''); ?>" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
							<input type="radio" name="gender" value="1" <?php echo e(($detail_user['gender'] == 1) ? 'checked' : ''); ?>> &nbsp; Nữ &nbsp;&nbsp;
							</label>
							<?php endif; ?>
						</div>
						</div>
					...
					<div class="item form-group <?php if(isset($errors['address'])): ?> bad <?php endif; ?>">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<textarea  name="address" id="address" class="form-control" rows="5"><?php if(isset($detail_user['address'])): ?> <?php echo e($detail_user['address']); ?> <?php endif; ?>
                  			</textarea>
						</div>
