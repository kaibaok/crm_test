...
<?php $__env->startSection('css'); ?> <link href="/public/js/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet"> <?php $__env->stopSection(); ?>
                    ...
                    <form class="form-horizontal form-label-left" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="userid" name="userid" class="form-control col-md-7 col-xs-12" value="<?php echo e(!empty($_GET['userid']) ? $_GET['userid'] : ''); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="name" name="name" class="form-control col-md-7 col-xs-12" value="<?php echo e(!empty($_GET['name']) ? $_GET['name'] : ''); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="email" class="form-control col-md-7 col-xs-12" type="text" name="email" value="<?php echo e(!empty($_GET['email']) ? $_GET['email'] : ''); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Địa chỉ</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="address" class="form-control col-md-7 col-xs-12" type="text" name="address" value="<?php echo e(!empty($_GET['address']) ? $_GET['address'] : ''); ?>">
                            </div>
                        </div>
                         <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Điện thoại</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="phone" class="form-control col-md-7 col-xs-12" type="text" name="phone" value="<?php echo e(!empty($_GET['phone']) ? $_GET['phone'] : ''); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Ngày đặt hàng</label>
                            <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                            <label class=" col-md-3 col-sm-3 "> Chọn <input name='cb_dat' type="checkbox" <?php echo e(!empty($_GET['cb_dat']) ? 'checked' : ''); ?>/></label>
                                <input type="text" class="form-control has-feedback-left" id="registered_date" aria-describedby="inputSuccess2Status" name="registered_date" value="<?php echo e(!empty($_GET['registered_date']) ? $_GET['registered_date'] : ''); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                            <label class=" col-md-3 col-sm-3 "> Chọn <input name='cb_ship' type="checkbox" <?php echo e(!empty($_GET['cb_ship']) ? 'checked' : ''); ?>/></label>
                                <input type="text" class="form-control has-feedback-left" id="ship_date" aria-describedby="inputSuccess2Status" name="ship_date" value="<?php echo e(!empty($_GET['ship_date']) ? $_GET['ship_date'] : ''); ?>">
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div id="paid" class="btn-group" data-toggle="buttons">
                                    <?php 
                                     ...
                                     ?>
                                        <label> <input type="radio" class="flat" name="paid" value="<?php echo e($key); ?>" <?php echo e($select); ?> /> <?php echo e($value); ?> </label>
                                    <?php  }  ?>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div id="type" class="btn-group" data-toggle="buttons">
                                    <?php 
                                     ...
                                     ?>
                                        <label> <input type="radio" class="flat" name="type" value="<?php echo e($key); ?>" <?php echo e($select); ?> /> <?php echo e($value); ?> </label>
                                    <?php  }  ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody id="tbl_alproduct">
                                <?php 
                                    ...
                                    $m_user = new App\User();
                                 ?>
                                <?php foreach($view['list_cart'] as $value): ?>
                                <?php   $info_user = $m_user->getInfoByUserid($value['userid']);  ?>
                                <tr class="even pointer">
                                    ...
                                    <td><i class="success fa fa-clock-o" title="Ngày đặt hàng"></i> <?php echo e($value['registered_date']); ?></td>
                                    <td><i class="success fa fa-clock-o" title="Ngày giao hàng"></i> <?php echo e($value['ship_date']); ?></td>
                                    <td><?php echo e($value['registered_date']); ?></td>
                                    <td><?php echo e($value['paid']); ?></td>
                                    <td class="last"> <a href="/admin/product/cart/edit/<?php echo e($value['id']); ?>"><i class="success fa fa-edit"></i> Sửa</a> | <a href="/admin/product/cart/del/<?php echo e($value['id']); ?>"><i class="success fa fa-remove"></i> Xóa</a> </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                        <div class="btn-toolbar pull-right">
                            <?php echo e($view['list_cart']->links()); ?>
