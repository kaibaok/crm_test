            ...
            <div class="x_panel">
              <div class="x_content">
                <?php echo e(csrf_field()); ?>
                    ...
                    <input type="hidden" name="id" value="<?php echo e(isset($tag['id']) ?  $tag['id'] : ''); ?>"/>
                    <div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Hiển thị</label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <div id="status" class="btn-group" data-toggle="buttons">
                              <label><input type="radio" class="flat" name="status" value="0" <?php if(isset($tag['status']) && $tag['status'] == 0): ?> checked <?php endif; ?> /> Ẩn </label>&nbsp;
                              <label><input type="radio" class="flat" name="status"  value="1" <?php if(isset($tag['status']) && $tag['status'] == 1): ?> checked <?php endif; ?> /> Hiện</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item form-group <?php if(isset($errors['title'])): ?> bad <?php endif; ?>">
                       ...
                       <input type="text" id="title" class="form-control col-md-7 col-xs-12" name="title" value="<?php echo e(isset($tag['title']) ?  $tag['title'] : ''); ?>" >
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" id="link" class="form-control col-md-7 col-xs-12" name="link" value="<?php echo e(isset($tag['link']) ?  $tag['link'] : ''); ?>" >
                        </div>
                    </div>
                </div>
            </div>
