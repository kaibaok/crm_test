                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <?php if(isset($product['size_xs']) && $product['size_xs'] == 1): ?> checked <?php endif; ?> /> XS
                                </label> <br>
                                <label><input type="checkbox" name="size_s" value="1" class="flat"
                                <?php if(isset($product['size_s']) && $product['size_s'] == 1): ?> checked <?php endif; ?> /> S
                                </label><br>
                                <label><input type="checkbox" name="size_m" value="1" class="flat"
                                <?php if(isset($product['size_m']) && $product['size_m'] == 1): ?> checked <?php endif; ?> /> M
                                </label><br>
                                <label><input type="checkbox" name="size_l" value="1" class="flat"
                                <?php if(isset($product['size_l']) && $product['size_l'] == 1): ?> checked <?php endif; ?> /> L
                                </label><br>
                                <label><input type="checkbox" name="size_xl" value="1" class="flat"
                                <?php if(isset($product['size_xl']) && $product['size_xl'] == 1): ?> checked <?php endif; ?> /> XL
                                </label>
                            </div>
                        </div>
                    </div>
