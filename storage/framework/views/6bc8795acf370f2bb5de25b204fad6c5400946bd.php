                        ...
                        <form id="contact-form-two" action="" method="post">
                            ...
                            <div class="form-top">
                                ...
                                <div class="form-group col-xs-12">
                                    ...
                                    <input name="email" type="email" class="form-control" value="<?php if(!empty($params['email'])): ?> <?php echo e($params['email']); ?> <?php endif; ?>">
                                    <?php if(!empty($errors['email'])): ?> <p class="form-message-two txt_error"><?php echo e($errors['email']); ?></p><?php endif; ?>
                                </div>
                                <div class="form-group col-xs-12">
                                    <label>Giới tính<span class="required" title="required">*</span></label><br>
                                    <label><input type="radio" name="gender" value="0" <?php if(isset($params['gender']) && $params['gender'] == 0): ?> checked <?php endif; ?>>Nam</label>
                                    <label><input type="radio" name="gender" value="1" <?php if(isset($params['gender']) && $params['gender'] == 1): ?> checked <?php endif; ?>>Nữ</label>
                                </div>
                                <div class="form-group col-xs-12">
