        ...
        <div class="title_right">
            <div class=" pull-right">
              <div class="input-group">
                ...
                <a class="btn btn-info" href="/admin/cart/edit/<?php echo e($cartID); ?>">Trở về</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_content autocomp">
                    ...
                    <input type="hidden" name="cart_id" value="<?php echo e($cartID); ?>">
                    <input type="hidden" name="product_id" id="product_id" value="<?php echo e(isset($params['product_id']) ? $params['product_id'] : ''); ?>">
                     <div class="item form-group  <?php if(isset($errors['name'])): ?> bad <?php endif; ?>">
                        ...
                        <input type="text" id="product_name" class="form-control col-md-7 col-xs-12" name="name" value="<?php echo e(isset($params['name']) ? $params['name'] : ''); ?>">
                        </div>
                    ...
                    <div class="item form-group  <?php if(isset($errors['price'])): ?> bad <?php endif; ?>">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" id="price" class="form-control col-md-7 col-xs-12" name="price" value="<?php echo e(isset($params['price']) ? $params['price'] : ''); ?>">
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" id="dprice" class="form-control col-md-7 col-xs-12" name="dprice" value="<?php echo e(isset($params['dprice']) ? $params['dprice'] : ''); ?>">
                        </div>
                    </div>
                    <div class="item form-group  <?php if(isset($errors['number'])): ?> bad <?php endif; ?>">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" id="number" class="form-control col-md-7 col-xs-12" name="number" value="<?php echo e(isset($params['number']) ? $params['number'] : ''); ?>">
                        </div>
                                ...
                                <?php if(!empty($product)): ?>
                                    ...
                                    <?php foreach($listColors as $key => $value): ?>
                                        <?php if(in_array($key, $chooseColor)): ?>
                                            <?php  $select = ($key == $params['color']) ? 'selected' : ''  ?>
                            ...
                            <select id="size" class="form-control col-md-7 col-xs-12" name="size">
                                <?php if(!empty($product)): ?>
                                    ...
                                    <?php foreach($listSize as $key => $value): ?>
                                        <?php if($value): ?>
                                            <?php  $select = ($params['size'] == $key) ? "selected" : "";  ?>
