                ...
                <div class="billing-detail">
                    ...
                    <form action="" method="post">
                        ...
                        <p>Họ và tên <span>*</span>
                            <br>
                            <input type="text" placeholder="Họ và tên" name="full_name" value="<?php echo e(!empty($info['full_name']) ? $info['full_name'] : ''); ?>"> <?php if(isset($errors['full_name'])): ?>
                            <span class="txt_error"><?php echo e($errors['full_name']); ?></span> <?php endif; ?>
                        </p>
                        <div class="row">
                            <p class="col-sm-6 col-xs-12">
                                Email <span>*</span>
                                <br>
                                <input type="email" placeholder="Email" name="email" value="<?php echo e(!empty($info['email']) ? $info['email'] : ''); ?>"> <?php if(isset($errors['email'])): ?>
                                <span class="txt_error"><?php echo e($errors['email']); ?></span> <?php endif; ?>
                            </p>
                            <p class="col-sm-6 col-xs-12">
                                Số điện thoại <span>*</span>
                                <br>
                                <input type="text" placeholder="Số điện thoại" name="phone" value="<?php echo e(!empty($info['phone']) ? $info['phone'] : ''); ?>"> <?php if(isset($errors['phone'])): ?>
                                <span class="txt_error"><?php echo e($errors['phone']); ?></span> <?php endif; ?>
                            </p>
                        </div>
                        <p id="address">Địa chỉ nhận <span>*</span>
                            ...
                            <input type="text" placeholder="Địa chỉ 2" name="address2" value="<?php echo e(!empty($info['address2']) ? $info['address2'] : ''); ?>"> <?php if(isset($errors['address'])): ?>
                            <span class="txt_error"><?php echo e($errors['address']); ?></span> <?php endif; ?>
                        </p>
                        ...
                        <div class="row">
                            ...
                            <p class="col-sm-6 col-xs-12">
                                Quận <span>*</span>
                                <br>
                                <input type="text" placeholder="Quận" name="district" value="<?php echo e(!empty($info['district']) ? $info['district'] : ''); ?>"> <?php if(isset($errors['district'])): ?>
                                <span class="txt_error"><?php echo e($errors['district']); ?></span> <?php endif; ?>
                            </p>
                        </div>
                        <div class="row">
            ...
            <div class="col-md-6">
                <div class="total-cart">
                    ...
                    <div class="your-order">
                        <?php if(!empty($sCart)): ?> <?php  $totalPrice = 0;  ?>
                                ...
                                <li>
                                    ...
                                    <?php foreach($sCart as $key => $value): ?>
                                        <?php 
                                         ...
                                         ?>
                                        <p><?php echo e($value['title']); ?> <span class="span_color_small" style="background: <?php echo e($listColors[$value['color']]['code']); ?>"></span> <span> <?php echo e($value['size']); ?> x <?php echo e($value['number']); ?></span><span><?php echo e($price * $value['number']); ?></span></p>
                                    <?php endforeach; ?>
                                </li>
                                <li>
